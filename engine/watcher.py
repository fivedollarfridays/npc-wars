"""The Cringe — adaptive AI boss bot for NPC Wars."""
...
class WatcherBot(Bot):
    """The Cringe: a special boss bot with full action access.

    Attributes:
        is_watcher: Always True for Cringe instances.
        is_player_bot: Always False — The Cringe is an NPC boss.
    """
