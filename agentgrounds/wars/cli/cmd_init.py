"""agentgrounds wars init — scaffold a new Agent Grounds arena."""
...
def register(subparser: argparse._SubParsersAction) -> None:
    ...
    p = subparser.add_parser("init", help="Initialize a new Agent Grounds arena")
    p.add_argument(
...
def run(args: argparse.Namespace) -> None:
    ...
    from agentgrounds.wars.builtin_bots import get_bot_source, list_builtin_bots
    from agentgrounds.wars.config import CONFIG_FILENAME, write_default_config
